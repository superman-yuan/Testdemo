...
//        objectMapper.setDateFormat(new SimpleDateFormat(DateTimeUtil.STANDARD_FORMAT));
     ...
     * @return
     */
    public static <T> String objStringPretty(T obj){
        if (obj == null){
            return null;
        }
        try {
     ...
     * @return
     */
    public static <T> T stringObj(String str,Class<T> clazz){
     ...
     * @return
     */
    public static <T> T stringObj(String str, TypeReference<T> typeReference){
     ...
     * @return
     */
    public static <T> T stringObj(String str,Class<?> collectionClass,Class<?>... elementClasses){
